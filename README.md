...
## 프로젝트 소개
- Spyder는 기존 국방모바일보안 앱을 보완한 솔루션으로, 머신러닝을 이용한 군장병 기밀유출 보안 솔루션입니다. 휴대폰 안에 저장된 사진들을 GPS 데이터를 이용해 검사하여 부대 내에서 찍은 미디어를 감지하고 스파이더 웹에 업로드 시킵니다. 감지된 사진들은 모바일 기기에서 즉시 삭제됩니다. Spyder 웹에 업로드 된 후, 감지된 사진들은 1착적 OpenCV 머신러닝 검증과 2차적 간부의 확인 후 병사의 휴대폰에서 다시 원본 파일의 다운로드가 가능합니다. 
